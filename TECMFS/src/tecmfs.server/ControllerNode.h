...
public:
	...
	string createParity(string a,string b); /*Obtain the parity given two binary strings.*/
	string recoverData(string a, string b, string c); /*Recover the last information from the rest.*/
};
